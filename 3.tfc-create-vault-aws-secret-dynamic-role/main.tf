...
resource "vault_aws_secret_backend" "aws" {
  ...
  access_key = data.terraform_remote_state.vault-admin.outputs.vault_admin_accesskey
  secret_key = data.terraform_remote_state.vault-admin.outputs.vault_admin_secret_accesskey
...
#       "Effect": "Allow",
#       "Action": "iam:*",
#       "Resource": "arn:aws:iam::905418241304:user/vault-token-terraform-*"
#     }
#   ]
# }
# EOT
